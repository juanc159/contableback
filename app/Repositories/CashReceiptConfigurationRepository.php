...
use App\Models\CashReceiptConfiguration; 

class CashReceiptConfigurationRepository extends BaseRepository
{
    public function __construct(CashReceiptConfiguration $modelo)
    {
