...
use App\Models\LedgerAccountSubAuxiliary;

class LedgerAccountSubAuxiliaryRepository extends BaseRepository
{
    public function __construct(LedgerAccountSubAuxiliary $modelo)
    {
