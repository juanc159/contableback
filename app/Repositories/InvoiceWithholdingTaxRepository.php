...
use App\Models\InvoiceWithholdingTax;

class InvoiceWithholdingTaxRepository  extends BaseRepository
{
    public function __construct(InvoiceWithholdingTax $modelo)
    {
