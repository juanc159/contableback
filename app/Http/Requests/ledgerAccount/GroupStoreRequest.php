...
class GroupStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            //'code' => 'required|min:2|max:2|unique:ledger_account_groups,code,'.$this->id,
            'name' => 'required',
    ...
    public function messages(): array
    {
        return [
            ...
            'code.min' => 'debe completar el codigo a 2 caracteres', 
            'code.max' => 'debe completar el codigo a 2 caracteres', 
