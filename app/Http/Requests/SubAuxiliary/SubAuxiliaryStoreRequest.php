...
namespace App\Http\Requests\SubAuxiliary;

use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Http\Exceptions\HttpResponseException;
use Illuminate\Contracts\Validation\Validator;

class SubAuxiliaryStoreRequest extends FormRequest
{
    /**
    ...
    public function messages(): array
    {
        return [
            ...
            'code.min' => 'debe completar el codigo a 10 caracteres', 
            'code.max' => 'debe completar el codigo a 10 caracteres',
